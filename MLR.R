...
beta_file='/Users/dilrajkaur/Desktop/UCEC/newdata/ucec_ML_output.csv'
...
val=data2$OS.time_KNN
print(median(val))

gene='KNN'

surv_object <- Surv(time = data2$OS.time_ACTUAL/30, event = data2$vital_status)
...
gg
ggsave('/Users/dilrajkaur/Desktop/UCEC/newdata/images/GENE_KM_'+gene+'.jpg', plot = print(gg),height = 5 ,width = 7, dpi = 1000)
